...
if __name__ == '__main__':
    ...
    parser.add_argument("-modeldir", default='../1kmodels', help="model folder")
    ...
    parser.add_argument("-base_cluster", default='../clustercenter/tdrive_clustercenter', help="base_cluster")
